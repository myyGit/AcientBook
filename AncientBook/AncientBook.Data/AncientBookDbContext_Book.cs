...
{
    public class AncientBookDbContext_Book : DbContext, IDbContextBook
    {
        public AncientBookDbContext_Book(string nameOrConnectionString)
            : base(nameOrConnectionString)
        {
        }
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            System.Type configType = typeof(TB_CategoryMap);  //any of your configuration classes here
